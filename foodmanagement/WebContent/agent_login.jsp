				...
				<div class="dropdown ">
						<a class=" nav-link"><li class="nav-item dropdown-toggle active" style="color:orange;" data-toggle="dropdown" data-target="#down1"><span class="caret">LOGIN</span></li></a>
								<div class="dropdown-menu" id="down1">
									...
									<div class="dropdown-divider"></div>							
									<a class="dropdown-item active" href="agent_login.jsp">AGENT</a>
...
<div class="container  " style="margin-top:44px;">
	<div class="row">
		...
		<div class=" col-lg-4 animated fadeInRight faster" style="margin-top:50px;">
				<form action="agent_login_action.jsp" method="post">
					<table class="table table-dark "><br><br><br>
						<tr><th colspan="2"><h3><b><center> AGENT LOGIN</center></b></h3></th></tr>
						<tr>
							<th colspan="2">
																<%
																...
																<%
																	...
																	{
																%>
																		<h5 ><font color="lightgreen"><i><b>Password Changed Successfully</b></i></font></h5>																	
																<%		
																	}																		
																%>
							</th>
						...
						<tr>
					 		...
					 		<tr>
								...
								<a href="agent_forgot.jsp" class="nav-link"  style="color:white; text-decoration:underline;"><i>Forgot password ?</i></a></td>
							</tr>
