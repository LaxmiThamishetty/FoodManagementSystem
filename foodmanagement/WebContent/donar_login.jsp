				...
				<div class="dropdown ">
						<a class=" nav-link"><li class="nav-item dropdown-toggle active" style="color:orange;" data-toggle="dropdown" data-target="#down1"><span class="caret">LOGIN</span></li></a>
								<div class="dropdown-menu" id="down1">
									...
									<a class="dropdown-item active" href="donar_login.jsp">DONAR</a>
									<div class="dropdown-divider"></div>							
...
<div class="container  " style="margin-top:44px;">
	<div class="row">
		<div class="col-lg-5 animated fadeInUp fast" style="margin-top:256px;">
					...
					<h1 style="font-family: 'Kaushan Script', cursive; font-size:85px; color:white;">Excess Food Wasteage Management System!</h1>
		</div>
		<div class="col-lg-3">
		
		</div>
		<div class=" col-lg-4 animated fadeInRight faster" style="margin-top:50px;">
				<form action="donar_login_action.jsp" method="post"> 	
					<table class="table table-dark"><br><br><br>
						<tr><th colspan="2"><h3><center><b>DONAR LOGIN</b></center></h3></th></tr>
						<tr>
							<th colspan="2">
																<%
																	...
																	{
																%>		
																		<h5 ><center><font color="red"><i>Please Enter Valid Username / Password</i></font></center></h5>
																<%
																}
																	else if(request.getParameter("id3")!=null)
																	{
																%>
																		<h5 ><center><font color="lightgreen"><i><b>Password Changed Successfully</b></i></font></center></h5>																	
																<%		
																	}							
																	else if(request.getParameter("id2")!=null)
																	{
																%>
																		<h4 ><center><font color="lightgreen"><i><b>Registered Successfully..</font></h4><h6><font color="orange"> Do you want to login ?</b></i></font></center></h6>	 																																
																		<a href="donar_reg.jsp"><input type="button" class="btn btn-block btn-danger" value="NO"></a>
						...
						<tr>
					 		...
					 		<tr>
								<td colspan="2"><input type="submit" value="Login" class="btn btn-block btn-success">
								<a href="donar_forgot.jsp" class="nav-link"  style="color:white; text-decoration:underline;"><i>Forgot password ?</i></a></td>
							</tr>
				</table>
			</form>
