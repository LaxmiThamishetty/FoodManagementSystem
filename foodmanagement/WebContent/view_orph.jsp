						...
						<div class="dropdown ">
								<a class=" nav-link"><li class="nav-item dropdown-toggle" style="color:orange;" data-toggle="dropdown" data-target="#down2"><span class="caret">VIEW</span></li></a>
										<div class="dropdown-menu" id="down2">
											...
											<div class="dropdown-divider"></div>							
											<a class="dropdown-item active" href="view_orph.jsp">View OrphanHomes</a>
											<div class="dropdown-divider"></div>							
...
<div class="container" style="margin-top:30px;">
	<div class="row">
		...
		<div class="col-lg-12 table-responsive">
						<h4 align="left" style="color:yellow;">ORPHAN HOME DETAILS</h4>
		...
		<%
				...
				<tr>
					...
					<td> <a href="delete_orphan.jsp?id=<%=c%>">delete</a> </td>
