...
<div class="container" style="margin-top:44px;">
	<div class="row">
		...
		<div class=" col-lg-4 animated fadeInRight faster" style="margin-top:50px;">
				...
				<form name="LoginForm" onSubmit="return fu();" action="donar_change_password_action.jsp" method="post"> 	
					<table class="table table-dark table-hover"><br><br><br>
						...
						<tr>	
							...
							<tr>
								<td ><a href="donar_login.jsp"><input type="button" value="Exit" class="btn btn-success btn-sm"></a>
								<a href="donar_forgot.jsp"><input type="button" value="Back" class="btn btn-success btn-sm"></a>
