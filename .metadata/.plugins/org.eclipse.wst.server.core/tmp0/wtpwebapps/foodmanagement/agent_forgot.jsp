...
<div class="container" style="margin-top:44px;">
	<div class="row">
		...
		<div class=" col-lg-4 animated fadeInRight faster" style="margin-top:50px;">
				...
				<form action="agent_forgot_action.jsp" method="post"> 	
					<table class="table table-dark table-hover"><br><br><br>
						...
						<tr>
							<th colspan="2">
																<%
																	...
																	{
																%>		
																		<h5 ><font color="red"><i>Please Enter Valid Username / mobile</i> </font></h5>
																<%} %>
							</th>
						</tr>
						<tr>	
						...
						<tr>	
								...
								<td><input class="table-dark" type="email/number" name="mail" required></td>
						</tr>
						
							<tr>
								<td ><a href="agent_login.jsp"><input type="button" value="Back" class="btn btn-success btn-sm"></a>
