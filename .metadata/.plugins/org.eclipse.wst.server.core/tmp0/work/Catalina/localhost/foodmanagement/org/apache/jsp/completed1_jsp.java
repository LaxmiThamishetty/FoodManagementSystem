 ...
 * Generated at: 2021-05-25 08:32:05 UTC
...
public final class completed1_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	//	System.out.println(area);
		...
		if(rs.next())
		{
				...
				int i=st.executeUpdate("update food_details set status='COMPLETED' where donar_name='"+dname+"' and food_decription='"+desc+"' and  area='"+area+"' and date_of_request='"+dt+"' ");
				if(i==1)	
				{
